 ...
 * [geontonet.yml](geontonet.yml)
     * Determines how your purl.obolibrary.org/obo/geontonet/ redirects will be handled
     ...
     * Paste in the contents of [geontonet.yml](geontonet.yml)
 ...
 * [geontonet.md](geontonet.md)
     ...
     * Paste in the contents of [geontonet.md](geontonet.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
